...
async function main() {
  ...
  `);
	...
	console.log(
		`   ✅ ${insertSuccesses}/50 inserts succeeded in ${Date.now() - insertStart}ms`,
	);
	...
	console.log(
		`   ✅ ${mixedSuccesses}/100 operations succeeded in ${Date.now() - mixedStart}ms`,
	);
	...
	console.log(
		`   ✅ ${txSuccesses}/10 transactions committed in ${Date.now() - txStart}ms`,
	);
