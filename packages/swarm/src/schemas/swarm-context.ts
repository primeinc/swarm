...
export type SwarmCellContext = z.infer<typeof SwarmCellContextSchema>;

/**
 * Args for creating a swarm context
 */
export const CreateSwarmContextArgsSchema = SwarmCellContextSchema.omit({
	id: true,
	created_at: true,
	updated_at: true,
});
