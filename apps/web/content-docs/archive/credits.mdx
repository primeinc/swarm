...
**Steve Yegge** ([@steveyegge](https://twitter.com/steveyegge)) - [cells](https://github.com/steveyegge/cells)

cells is AI-native issue tracking that lives in your repo. The `cells_*` tools in our plugin wrap the cells CLI with type-safe validation.
