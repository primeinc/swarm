...
**Why?** Frameworks impose opinions. Primitives enable creativity. You might need event sourcing without the full plugin. You might want file reservations without cells. Mix and match.
...
// ✓ Parse at boundary
const validated = cellSchema.parse(data);
...
Use cell IDs as thread IDs for all coordination messages. This keeps conversations organized and traceable.
